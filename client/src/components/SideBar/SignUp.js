...
const SignUp = ({ signUpSwitch, modalSwitch, signUpModal }) => {
	...
	return (
		<div className="modal" style={modalSwitch(signUpSwitch)}>
			...
			<input className="password" value={email} type="text" placeholder="password" onChange={(e) => setPassword(e.target.value)} />
			<input className="username" value={username} type="text" placeholder="username" onChange={(e) => setUsername(e.target.value)} />
			<br />
			<label>Male: </label>
