...
// 		axios.post("https://cinephile.tk/board/write", variables)
// 		.then((res) => {
...
class CreateText extends Component {
		...
		imageUploader: {
			upload: (file) => {
				return new Promise((resolve, reject) => {
					...
					fetch('https://cinephile.tk/setting/upload', {
						method: 'POST',
	...
	onSubmit(e) {
		...
		axios.post('https://cinephile.tk/board/write', variables).then((res) => {
		...
		return (
			<div style={{ maxWidth: '700px', margin: '2rem auto' }}>
				...
				<form onSubmit={this.onSubmit}>
					...
					/>
					<ReactQuill className="quil" modules={this.modules} formats={CreateText.formats} value={this.state.content} placeholder="내용을 입력하세요" onChange={this.onHandleChange} />
